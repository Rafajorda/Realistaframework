...
//         .then(function (data) {
//             var carouselList = $('.carousel__list');
//             carouselList.empty(); // Limpiar contenido previo del carrusel

//             for (var row in data) {
//                 var item = $("<div class='carousel__item'></div>");
//                 var image = $("<img class='carousel__img' src='" + data[row].imgahorro + "' alt=''>");
//                 var button = $("<button class='btn div_ahorro' id='" + data[row].idahorro + "'>" + data[row].nameahorro + "</button>");

//                 item.append(image).append(button);
...
function loadCities() {
 ...
 function loadvisitas() {
     ajaxPromise('module/Home/controller/controller_vivienda.php?op=homePageVisitas','GET', 'JSON')
...
function loadoperations() {
 ...
 function loadrecommend() {
    // console.log('loadcategories');
     ajaxPromise('module/Home/controller/controller_vivienda.php?op=homePagerecommend','GET', 'JSON')
...
//     .then(function(data) {
//         for (row in data) {
//             var newahorro = $('<div></div>').addClass('col-md-3 col-sm-6 div_ahorro')
//             .attr('data-idahorro', data[row].idahorro)
//             .attr('id', data[row].idahorro)
//             .append(
//                 "<li class='portfolio-item'>" +
//                 "<div class='item-main'>" +
//                 "<div class='portfolio-image'>" +
//                 "<img src='" + data[row].imgahorro + "' alt='foto' />" +
//                 "<div class='overlay'>"+
//                " <a class='preview btn btn-primary' title="+data[row].nameahorro+">VIEW</a>"+
//             "</div>"+
//                 "</div>" +
//                 "<h5>" + data[row].nameahorro + "</h5>" +
//                 "</div>" +
//                 "</li>"
//             );
    
//         $('#containerahorro').append(newahorro);
